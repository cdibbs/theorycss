!function(e){"object"==typeof exports?module.exports=e():"function"==typeof define&&define.amd?define(e):"undefined"!=typeof window?window.Compiler=e():"undefined"!=typeof global?global.Compiler=e():"undefined"!=typeof self&&(self.Compiler=e())}(function(){var define,module,exports;
...
},{"./expressions":4,"./state-manager":6,"./tree-fragments":7,"underscore":1}],3:[function(require,module,exports){
"use strict";
...
},{"../util":8,"./errors":3}],5:[function(require,module,exports){
var u = require('../util').u,
...
function LeafDict(nodeId, typeList, isList) {
	...
	self.evalDefList = function evalDefList(defList, scope) {
		...
		defList.every(function(def) {
			var result = expr.evaluate(def, scope);
			if (! result instanceof Object) {
				throw new Exception("Not a dictionary.");
			}
			for (var key in result[1]) {
				result[1][key] = expr.evaluate(result[1][key], scope);
			}
			dicts.push(result);
			return true;
		});
...
},{"../util":8,"./expressions":4}],6:[function(require,module,exports){
"use strict";
...
},{"../util":8,"./errors":3,"./leafdict":5}],8:[function(require,module,exports){
"use strict";
