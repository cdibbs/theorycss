(function(e){if("function"==typeof bootstrap)bootstrap("compiler",e);else if("object"==typeof exports)module.exports=e();else if("function"==typeof define&&define.amd)define(e);else if("undefined"!=typeof ses){if(!ses.ok())return;ses.makeCompiler=e}else"undefined"!=typeof window?window.Compiler=e():global.Compiler=e()})(function(){var define,ses,bootstrap,module,exports;
...
exports.Err = {
	...
	Unsupported : function(msg, meta) {
		this.toString = function() {
			...
			return msg + " " + meta.loc.first_line + ":" + meta.loc.first_column; };
	}
};
